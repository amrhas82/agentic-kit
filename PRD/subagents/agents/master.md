...
- **\*knowledge-base**: Toggle KB mode off (default) or on, when on will load and reference the .claude/data/knowledge-base.md and converse with the user answering his questions with this informational resource
